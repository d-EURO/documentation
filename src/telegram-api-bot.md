...
* Quick access: the bot provides direct links to the Decentralized Euro app, the blockchain explorer for relevant addresses and transactions, and the GitHub repository.
...
Use the command `/help` to get your subscription state. A handle is a toggle — sending it once subscribes, sending it again unsubscribes.

### Minting Updates

Provides updates on minting activities, including changes in minted amounts, collateral ratios, and fee information.
