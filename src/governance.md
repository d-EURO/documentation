...
2. Proposals for new minting modules pass after a minimum 14 days unless someone vetoes them. When proposing new types of collateral in the minting hub, the position initialization period must be at least 3 days (V3) or 14 days (V2). These are minimum durations. When making a proposal, it is recommended to give the system participants significantly more time to assess the proposal in order to avoid being vetoed simply because there was not enough time for discussion.
